    ...
    return (
        <section id="contact" className="py-16 md:py-24 bg-blush/30 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-soft border border-gold/10">

                    {/* Contact Information */}
                    <div className="p-6 sm:p-8 md:p-10 lg:p-14 bg-floral-green text-cream relative overflow-hidden">
                        ...
                        <div className="space-y-5 sm:space-y-8 relative z-10">
                            ...
                            <a href="mailto:omkarflowershop@gmail.com" className="flex items-start group">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-cream/10 flex items-center justify-center mr-3 sm:mr-4 group-hover:bg-gold transition-colors flex-shrink-0">
                                    <Mail size={18} className="text-cream group-hover:text-white" />
                                </div>
                                <div className="min-w-0">
                                    <p className="font-body text-xs sm:text-sm text-cream/70 uppercase tracking-wider mb-0.5 sm:mb-1">Email</p>
                                    <p className="font-heading text-base sm:text-lg break-all">omkarflowershop@gmail.com</p>
                                </div>
                            </a>

                            <a href="https://goo.gl/maps/MorabadiRanchi" target="_blank" rel="noopener noreferrer" className="flex items-start group">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-cream/10 flex items-center justify-center mr-3 sm:mr-4 group-hover:bg-gold transition-colors flex-shrink-0">
                                    <MapPin size={18} className="text-cream group-hover:text-white" />
                                </div>
                                <div>
                                    <p className="font-body text-xs sm:text-sm text-cream/70 uppercase tracking-wider mb-0.5 sm:mb-1">Address</p>
                                    <p className="font-heading text-base sm:text-lg leading-snug">Opp. Hanuman Mandir, Morabadi, Ranchi</p>
                                </div>
                            </a>
                            ...
                            <a href="https://www.instagram.com/omkar_flowers_?igsh=NDFseHlkcDJqZ2Yx_" target="_blank" rel="noopener noreferrer" className="flex items-start group">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-cream/10 flex items-center justify-center mr-3 sm:mr-4 group-hover:bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 transition-all flex-shrink-0">
                                    <Instagram size={18} className="text-cream group-hover:text-white" />
                                </div>
                                <div>
                                    <p className="font-body text-xs sm:text-sm text-cream/70 uppercase tracking-wider mb-0.5 sm:mb-1">Instagram</p>
                                    <p className="font-heading text-base sm:text-lg break-all">@omkar_flowers_</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    {/* Map Embed Location */}
                    <div className="h-[300px] sm:h-[400px] lg:h-auto lg:min-h-[400px] relative w-full bg-gray-100">
                        <iframe
