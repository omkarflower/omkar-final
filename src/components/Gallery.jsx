                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[200px]">
                    {galleryImages.map((img, index) => (
                        <motion.div
                            ...
                            className={`relative overflow-hidden rounded-2xl cursor-pointer group ${img.cls}`}
                    ...
                    >
                        ...
                        >
                            <img
                                src={selectedImg.src}
                                alt={selectedImg.alt}
                                className="max-h-[85vh] object-contain rounded-lg shadow-2xl border-4 border-white/10"
                            />
                        </motion.div>
                    </motion.div>
                )}
